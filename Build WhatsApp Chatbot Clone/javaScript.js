$(function () {
  ...
  // timing concept used to last seen time of the user-friendly format
  var k = "";
  var d = new Date(); // which is retrives the current date and time
  var h = d.getHours(); // retrieves the current hour
  var t = d.getMinutes(); // retrieves the current time
  t = t - 3;
  10 > h ? (h = "0" + h) : (h = h); // it is hours of the formating
  10 > t ? (t = "0" + t) : (t = t); // it is minutes of the formating
  12 > h ? (time = h + ":" + t + " am") : (time = h - 12 + ":" + t + " pm"); // handle the AM and PM
  ...
  function send() {
    ...
    isInArray(hello, lastmsg) == true
      ...
      ? ((smsg = "I am Gautam Sharma"), (k = smsg))
      ...
      ? ((smsg =
          "Thanks for checking my social media platforms.If you loved my content I kindly request you to link, subscribe & follow our social platforms @Gautam Sharma "),
        (k = smsg),
        setTimeout(function () {
          $(".status").html("last seen today at " + time);
        }, 6000),
      ...
      : ((smsg =
          "Sorry, I didn't understand, please explain it with proper spellings or  If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search Gautam Sharma</b>"),
        (k =
          "Sorry, I didn't understand, please explain it, with proper spellings, or  If you say, so I can search for you. To search,type,Search Your keyword,for example, type, Search Gautam Sharma "));
    para = $(
